...
/*视频切换轮播js*/
var length2 = $('.conbox1').find('div').length;
var flag2 = 2;
function auto2(){
...
if(flag2>length2) flag2=1;
	$('#sps'+flag2).show();
$('#a'+flag2).attr('class','cur');
	flag2++;
}
tt = setInterval("auto2()", 4000);
$('.switcher1 a').mousemove(function(){
	flag2 = $(this).attr('value');
	auto2();
	clearInterval(tt);
});

$('.switcher1').hover(function(){},function(){
	tt = setInterval("auto2()", 4000);
});
